...
const processSteps = [
  {
    ...
    description: "Document your trading rules—entries, exits, position sizing.",
  ...
  },
  {
    ...
    description: "Rules translated to technical specs. You review before coding.",
    duration: "2-4 days",
  },
  {
    step: 3,
    ...
    description: "Build automated system with clean, documented code.",
    duration: "1-4 weeks",
  },
  {
    step: 4,
    ...
    description: "Deploy with monitoring, alerts, and support.",
    duration: "Ongoing",
  },
  {
    step: 5,
    icon: BarChart3,
    title: "Paper Trading",
    description: "Live market testing without capital risk.",
    duration: "1-5 days",
  }
];
